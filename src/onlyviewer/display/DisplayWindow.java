...
public class DisplayWindow extends Application {
    ...
    public void start(Stage stage) {
        ...
        FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/onlyviewer/display/resources/fxml/DisplayWindow.fxml"));
        Parent root = null;
        try {
        ...
        if (root != null) {
            ...
            stylesheets.addAll(this.getClass().getResource("/onlyviewer/display/resources/css/display.css").toExternalForm());
        }
        ...
        stage.show();
        System.out.println("Starting a new onlyviewer.display window...");
    }
