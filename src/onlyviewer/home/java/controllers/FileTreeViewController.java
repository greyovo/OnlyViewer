...
import onlyviewer.home.java.model.SortParam;
                    ...
                    protected void updateItem(File item, boolean empty) {
                        ...
                        if (!empty) {
                            ...
                            if (this.getTreeItem().isExpanded()) {
                                ImageView folderImage = new ImageView("onlyviewer/home/resources/icons/opened_folder.png");
                                ...
                                ImageView folderImage = new ImageView("onlyviewer/home/resources/icons/folder.png");
                                folderImage.setPreserveRatio(true);
                                folderImage.setFitWidth(22);
                                hBox.getChildren().add(folderImage);//加图片
                                this.setGraphic(hBox);
