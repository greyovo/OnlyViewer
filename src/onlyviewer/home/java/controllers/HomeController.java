...
import onlyviewer.home.java.components.*;
import onlyviewer.home.java.model.*;
...
public class HomeController extends AbstractController implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        initSearchTextField();
        initPathTextField();
        System.out.println("onlyviewer.Main window initialization done...");
    }
...
//                    index = loadPic(imageModelList, imageListPane, index);
    ...
    private void initIntroPage() {
        ImageView welcomeImage = new ImageView(new Image("/onlyviewer/home/resources/images/intro.png"));
    ...
    public void showNotFoundPage() {
        ImageView img = new ImageView(new Image("/onlyviewer/home/resources/images/no_result.png"));
    ...
    private void showAboutDetail() {
        ...
        ImageView icon = new ImageView(new Image("onlyviewer/home/resources/icons/app_icon_300px.png"));
